<div class="row">
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-12">
                <a href="<?php echo site_url('edit_setting.aspx') ?>" class="btn btn-warning">
                    <i class="fa fa-shopping-cart"></i> Setting Data Toko
                </a>
                <a href="<?php echo site_url('edit_setting_tambahan.aspx') ?>" class="btn btn-info">
